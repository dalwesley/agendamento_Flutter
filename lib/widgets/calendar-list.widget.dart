                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Dismissible(
                                ...
                                child: ListTile(
                                  leading: todo.agendamentoAgente == '@ @'
                                      ? CircleAvatar(
                                          backgroundColor: Color(0xFF585393),
                                          child: Text(
                                            todo.agendamentoAgente[0],
                                            style: TextStyle(
                                  ...
                                  trailing: Column(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        todo.agendamentoHoraAgendada.toString(),
                                        style: todo.agendamentoConcluido == true
                                            ? TextStyle(
                                                fontSize:
                                                    constraints.maxWidth * 0.03,
